...
function DetailPage(){
    ...
    window.addEventListener("scroll", function(event){
        ...
        {
          if(scroll > section[i].offsetTop - window.outerHeight/0.8
    ...
    return(
        ...
        <section>
            <div class="contentWrap">
                <div class="imageWrap">
                    <img class="sampleimg" src={sampleimg} alt="블레이저 미드"/>
                </div>
                <div class="detailWrap">
                    <h1 class="productName">나이키 블레이저 미드 '77 빈티지</h1>
                    <p class="productdetail">나이키 블레이저 미드 '77 빈티지는 빈티지한 중창 마감 처리로 나이키 올드 스쿨 농구화의 느낌을 살렸으며, 마치 수년간 보관해온 듯한 룩을 연출합니다.</p>
                </div>
                <div class="buyWrap">
                    <button class="zzim" type="button">❤️ 찜하기</button>
                    <button class="alarmbtn" type="button">🔔 알람설정</button>
                    <br />
                    <a href="#">최저가 사러가기 👉</a>
                </div>
            </div>
